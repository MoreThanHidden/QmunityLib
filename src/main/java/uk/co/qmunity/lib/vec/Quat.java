...
public class Quat {
    ...
    public Quat(Vec3d axis, double angle) {
        ...
        x = axis.xCoord * sinHalfAngle;
        y = axis.yCoord * sinHalfAngle;
        z = axis.zCoord * sinHalfAngle;
        w = Math.cos(angle / 2D);
    }
    ...
    public Vec3d mul(Vec3d v) {
        ...
        rx += w * (y * v.zCoord - z * v.yCoord);
        ry += w * (z * v.xCoord - x * v.zCoord);
        rz += w * (x * v.yCoord - y * v.xCoord);
